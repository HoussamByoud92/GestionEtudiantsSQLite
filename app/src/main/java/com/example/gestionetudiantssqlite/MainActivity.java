package com.example.gestionetudiantssqlite;
...
import com.example.gestionetudiantssqlite.classes.Etudiant;
import com.example.gestionetudiantssqlite.service.EtudiantService;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().hide(); // ✅ This avoids crash
        }
